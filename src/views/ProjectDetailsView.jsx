      ...
      <div className="px-6 md:px-12 py-16 max-w-6xl mx-auto">
         <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-4 space-y-8">
               ...
               <RevealSection delay={0.3} type="slide-right">
                 <div className="border-t border-neutral-300 dark:border-neutral-800 pt-4">
               ...
               <RevealSection delay={0.4} type="slide-right">
                 <div className="border-t border-neutral-300 dark:border-neutral-800 pt-4">
               ...
               <RevealSection delay={0.5} type="scale">
                 <div className="border-t border-neutral-300 dark:border-neutral-800 pt-4">
            ...
            <div className="md:col-span-8">
               ...
               <RevealSection delay={0.4} type="default">
                 <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-12 text-lg">{project.longDesc}</p>
               </RevealSection>
                 ...
                 <div className="mb-12">
                    ...
                    <div className="flex flex-wrap gap-3">
                       {project.stack.map((tech, i) => (
                          <span key={i} className="px-4 py-2 border border-neutral-300 dark:border-neutral-700 text-sm uppercase">{tech}</span>
                       ))}
                    </div>
                 </div>
               </RevealSection>
               ...
               <div className="grid grid-cols-1 gap-8 mt-16">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                     <RevealSection delay={0.3} type="blur">
                       <div className="w-full aspect-square bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center border border-neutral-300 dark:border-neutral-800">
                         <span className="font-mono text-xs uppercase tracking-widest opacity-50">[ Mobile View ]</span>
                       </div>
                     </RevealSection>
                     <RevealSection delay={0.4} type="blur">
                       <div className="w-full aspect-square bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center border border-neutral-300 dark:border-neutral-800">
                         <span className="font-mono text-xs uppercase tracking-widest opacity-50">[ UI Kit ]</span>
                       </div>
                     </RevealSection>
                  </div>
               </div>
