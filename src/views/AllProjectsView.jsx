  ...
  return (
    ...
    >
       <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-neutral-300 dark:border-neutral-800 pb-8">
          <div>
             <button onClick={() => setView('home')} className="flex items-center gap-2 text-xs uppercase tracking-widest mb-6 hover:text-blue-500 transition-colors"><ArrowLeft size={14} /> {t.nav.back}</button>
